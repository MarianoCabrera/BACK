...
/*
usuario_db : es un objeto que sera invocado desde los endpoint del controlador. Aquí en el MODEL, dicho objeto posee las funcionalidades que permiten la interaccion con la base de datos como getAll, update, etc. Entonces desde seguridad.js puedo invocar a usuario_db.update(); o usuario_db.borrar();

funCallback: en una funcion que la enviamos desde el endpoint del controlador, es mediante esta funcion que le damos una respuesta desde el MODEL hacia el CONTROLLER, aquí lo que enviamos como error o detalles con mensajes, es lo que recibira seguridad.js para seguir su proceso de respuesta hacia el forontend
*/
...
usuario_db.create = function (usuario, funcallback) {
    ...
    consulta = "INSERT INTO usuario (id, email, nickname, password, clave, ) VALUES (?,?,?,?);";
